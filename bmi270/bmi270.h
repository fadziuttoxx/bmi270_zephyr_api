...
#define BMI270_ANYMO_INT_STATUS0		0x40

#define BMI270_NOMO_1_DURATION_POS	0
#define BMI270_NOMO_1_DURATION_MASK	BIT_MASK(12)
#define BMI270_NOMO_1_DURATION(n)	((n) << BMI270_NOMO_1_DURATION_POS)
#define BMI270_NOMO_1_SELECT_X		BIT(13)
#define BMI270_NOMO_1_SELECT_Y		BIT(14)
#define BMI270_NOMO_1_SELECT_Z		BIT(15)
#define BMI270_NOMO_1_SELECT_XYZ	(BMI270_NOMO_1_SELECT_X | \
					 BMI270_NOMO_1_SELECT_Y | \
					 BMI270_NOMO_1_SELECT_Y)
#define BMI270_NOMO_2_THRESHOLD_POS	0
#define BMI270_NOMO_2_THRESHOLD_MASK	BIT_MASK(10)
#define BMI270_NOMO_2_THRESHOLD(n)	((n) << BMI270_NOMO_2_THRESHOLD_POS)
#define BMI270_NOMO_2_OUT_CONF_POS	11
#define BMI270_NOMO_2_OUT_CONF_MASK	(BIT(11) | BIT(12) | BIT(13) | BIT(14))
#define BMI270_NOMO_2_ENABLE		BIT(15)
#define BMI270_NOMO_2_OUT_CONF_OFF	(0x00 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_0	(0x01 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_1	(0x02 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_2	(0x03 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_3	(0x04 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_4	(0x05 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_5	(0x06 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_6	(0x07 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_2_OUT_CONF_BIT_8	(0x08 << BMI270_NOMO_2_OUT_CONF_POS)
#define BMI270_NOMO_INT_STATUS0		0x20
...
#define BMI270_INT_STATUS_NO_MOTION			BIT(5)
...
struct bmi270_data {
	...
	sensor_trigger_handler_t nomotion_handler;
	const struct sensor_trigger *motion_trigger;
	const struct sensor_trigger *nomotion_trigger;
...
struct bmi270_feature_config {
	...
	struct bmi270_feature_reg *nomo_1;
	struct bmi270_feature_reg *nomo_2;
};
...
int bmi270_init_custom(const struct device *dev);

int bmi270_feature_reg_read(const struct device *dev, const struct bmi270_feature_reg *reg, uint16_t *value);

int bmi270_feature_reg_write(const struct device *dev, const struct bmi270_feature_reg *reg, uint16_t value);
